...
export default function ButtonSidebarPanel({
	...
	const buttonStyle =
		data.template?.buttonStyle ?? ButtonPropsDefaults.buttonStyle;
	const buttonTextColor =
		data.template?.buttonTextColor ?? ButtonPropsDefaults.buttonTextColor;
	const buttonBackgroundColor =
		data.template?.buttonBackgroundColor ??
		ButtonPropsDefaults.buttonBackgroundColor;

	return (
		<BaseSidebarPanel
			title="Button block"
			dataTestId="button-inspect-panel"
		>
			<TextInput
				label="Text"
				defaultValue={text}
			...
			<RadioGroupInput
				...
				dataTestId="inspect-panel-width-field"
			>
			...
			<RadioGroupInput
				...
				dataTestId="inspect-panel-size-field"
			>
